...
const AboutMe: React.FC = () => {
  return (
    <section id="AboutMe" className="bg-white dark:bg-slate-950 py-20 px-6 md:px-12 lg:px-24 overflow-hidden">
      {/* Header */}
      <motion.div 
      ...
      >
        ...
        <div className="w-16 h-1 bg-lemon-400 mx-auto mt-4 rounded-full" />
      </motion.div>
<motion.div className="space-y-8">
          <div className="space-y-4">
            ...
            <h3 className="text-3xl md:text-4xl font-bold leading-tight text-slate-800 dark:text-slate-100">
              ...
              <span className="text-slate-400 font-light">&</span> Business Logic (MBA)
            </h3>
      ...
      >
        <ServiceCard icon={<Code2 className="w-6 h-6" />}
         ...
         />
          <ServiceCard  icon={<User className="w-6 h-6" />}
         ...
         />
          <ServiceCard icon={<Briefcase className="w-6 h-6" />}
